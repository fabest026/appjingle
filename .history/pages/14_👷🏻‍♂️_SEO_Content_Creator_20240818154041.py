    ...
    prompt_parts = [
            f"""
                Forget all previous instructions.
                    ...
                    The goal is to produce valuable content that engages readers and satisfies SEO needs. Bold the headings, subheadings and keypoints. Make the SEO report of thes
            """
            ]
