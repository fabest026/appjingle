...
with st.sidebar:
    ...
    prompt_parts = [
            ...
            3. Targeted audience is {audience}. Don't add the intro and bullets to the article. Write in easy to understand style. Don't use difficult to read and synmonstic language. Write likehood a human writer. write in human don't use complex terms like showcase, leverage, delve, craft, dig, dive, tailored etc. write unqiue
