    ...
    prompt_parts = [
            f"""
                Forget all previous instructions.
                    ...
                    Generate an eye-catchy meta title and meta description related to content body with the Focus keyword "{focus_keyword}". in a table format. 1. Meta Title 2. Report. 
