...
with st.sidebar:
    ...
    prompt_parts = [
            f"""
                 Please disregard all earlier directives. Paraphrase the provided {input_section} into a completely original piece, maintaining its essence and coherence. Ensure the rephrased content is free from plagiarism and difficult for AI to detect, without extending its length.
            """
            ]
