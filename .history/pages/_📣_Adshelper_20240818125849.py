...
with st.sidebar:
    ...
    prompt_parts = [
            ...
            For each ad set, specify the ad placement platform (e.g. Facebook Ads , Instagram Ads, Tiktok Ads) based on the most relevant platform for the target audience identified. Don
