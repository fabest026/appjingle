...
with st.sidebar:
    ...
    # Section Heading
<<<<<<<<<<<<<<  ✨ Codeium Command 🌟  >>>>>>>>>>>>>>>>
    focus_keyword = st.text_input("Primary Keyword (required)", placeholder="e.g. keyword research, SEO tools, content marketing")
    focus_keyword = st.text_input("Primary Keyword (required)")
<<<<<<<  1d490574-13fb-41f2-acc2-f0d3f55bd4c3  >>>>>>>
    ...
    #Heading Counter
    num_headings = st.number_input("Number of Headings", min_value=6, max_value=20, step=1)
