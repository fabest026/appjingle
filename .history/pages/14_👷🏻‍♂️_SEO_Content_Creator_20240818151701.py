    ...
    prompt_parts = [
            f"""
                Forget all previous instructions.
                    ...
                    9. Inject naturally Primary Keyword atleast 3 times in content body.
                    10. Inject naturally the Secondary keyword atleast 2 times  precisely in content body and density must be less than 0.3%.
