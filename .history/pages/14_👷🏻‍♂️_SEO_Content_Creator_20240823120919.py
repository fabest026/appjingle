...
with st.sidebar:
    ...
    # Add the Voice Tones
    voice_tones = st.sidebar.selectbox("Choose Voice Tones:", ["Formal", "Informal", "Friendly", "Bold", "Adventurous", "Witty", "Perso" "Professional", "Casual", "Informative", "Creative", "Trendy", "Caring", "Cheerful", "Excited", "Funny", "Sad", "Serious", "Tense", "Vulnerable", "Angry", "Surprised", "Worried", "Assertive", "Confident", "Cooperative", "Encouraging" ])
            ...
            f"""
                Forget all previous instructions.
                    ...
                    The goal is to produce valuable content that engages readers and satisfies SEO needs.  
                     ...
                     Make the SEO Optimization grade Report in a table format. 1. Heading 2. Report. 3. Emojis.  Check the content AI generated is fully SEO rules following. 
                        1. Optimization Garde.
                        1. Content must be {num_words} words.
                        2. Meta title length must be less than 60 characters.
                        3. Meta description length must be less than 160 characters.
                        4. Focus Keyword must be in First 100 words of Introduction.
                        5. Focus Keyword must be in H1
                        6. Primary Keyword must be in H2.
                        7. Secondary Keyword must be in H3.
                        8. External links in whole content body at least 3 times
                        4. Content must be plagiarism free.
                        5. Content must not be generated by AI.
                        3. Use Focus Keyword must be at the beginning of the main title
                        4. Focus Keyword density must be less than 0.2%.
                        9. Primary keyword density must be less than 0.1%.
                        10.Secondary keyword density must be less than 0.1%
                    ...
                    Write the 3 image prompts with the Focus keyword , Primary Keyword , Secondary Keyword for the designer ai and ideogram ai in the table format. 1. Keywords. 2. Prompts.  
