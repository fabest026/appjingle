    ...
    prompt_parts = [
            f"""
                Forget all previous instructions.
                    ...
                    Write the 3 image prompt acording to article content body with the Focus keyword "{focus_keyword}", Primary Keyword "{primary_keyword}", Secondary Keyword "{secondary_keywords}" for the designer ai and ideogram ai in the table format. 1. Heading 2. Prompt.  
