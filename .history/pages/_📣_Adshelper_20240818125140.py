...
with st.sidebar:
    ...
    # Country
    country_options = ["United States", "Canada", "United Kingdom", "Australia",  "Germany", "France", "India", "Pakistan", "UAE", "Bangaladesh" "Nigeria", "Brazil", "Russia", "China", "Japan", "South Korea", "South Africa", "Spain", "Italy", "Turkey", "Netherlands", "Belgium", "Sweden", "Switzerland", "New Zealand", "Singapore", "Malaysia"]
