...
with st.sidebar:
    ...
    prompt_parts = [
            ...
            I want you to write a 5 variations of Facebook ad copy for a product/service that I will provide as the following {section_heading}, using the following guidelines:
