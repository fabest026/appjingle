...
with st.container():
    title = "<h1> <div style='text-align: center;'><font color='#ec1c25'>App</font><font color='#019649'>Jingle</font> IT Solutions</div></h1>"
    ...
    moto_line = "<div style='text-align: center;'>AppJingle is a company that provides value to clients by combining our experience with our commitment to deliver quality service to our customers.</div>"
