...
with st.container():
    title = "<h1> <div style='text-align: center;'><font color='#f48fb1'>App</font><font color='#019649'>Jingle</font> Solutions</div></h1>"    st.markdown(title, unsafe_allow_html=True)
